...
def main():
    ...
    ppi_path = '/opt/data/private/zzg/GNN_PPI-main/data/protein.actions.SHS148k.STRING.txt'
    bigger_ppi_path = '/opt/data/private/zzg/GNN_PPI-main/data/9606.protein.actions.all_connected.txt'
    bigger_pseq_path = '/opt/data/private/zzg/GNN_PPI-main/data/protein.STRING_all_connected.sequences.dictionary.tsv'
    vec_path = '/opt/data/private/zzg/GNN_PPI-main/data/vec5_CTC.txt'
    device = args.device

    ppi_data = GNN_DATA(ppi_path=ppi_path, bigger_ppi_path=bigger_ppi_path)

    ppi_data.get_feature_origin(pseq_path=bigger_pseq_path, vec_path=vec_path)
    ...
    fake_edge_num = 0
    index_path = '/opt/data/private/zzg/GNN_PPI-main/train_valid_index_json/random_string_test.json'
    ...
    gnn_model = '/opt/data/private/zzg/GNN_PPI-main/save_model/gnn_random_mode_shs148k_test/gnn_model_train.ckpt'
    model.load_state_dict(torch.load(gnn_model)['state_dict'])
