...
def main():
    ...
    ppi_path = '/opt/data/private/zzg/GNN_PPI-main/data/9606.protein.actions.all_connected.txt'
    pseq_path = '/opt/data/private/zzg/GNN_PPI-main/data/protein.STRING_all_connected.sequences.dictionary.tsv'
    vec_path = '/opt/data/private/zzg/GNN_PPI-main/data/vec5_CTC.txt'
    # esm2_path = '/opt/data/private/zzg/GNN_PPI-main/data/esm2_shs148k.csv'
    ...
    index_path = '/opt/data/private/zzg/GNN_PPI-main/train_valid_index_json/random_string_test_1.json'
    ...
    # esm = pd.read_csv(esm2_path, header=None)
    # esm = np.array(esm)
    # esm = torch.tensor(esm)
    # esm = esm.to(torch.float32).to(device)
    ...
    gnn_model = '/opt/data/private/zzg/GNN_PPI-main/save_model/gnn_random_mode_string_test1/gnn_model_valid_best.ckpt'

    model.load_state_dict(torch.load(gnn_model)['state_dict'], strict=False)
